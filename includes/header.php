  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li class="treeview">
       ...
       <!--PAYROLL-->
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href=""><i class="fa fa-circle-o"></i>Make Payment</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i>Generate Payslip</a></li>
      ...
      <li>
         ...
         <li>
          <a href="agency-staff.php">
            <i class="fa fa-users"></i> <span>Agency Staff</span>
       ...
       <li class="treeview">
          <a href="#">
            <i class="fa fa-building"></i> <span>Clients & Leads</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
	     ...
	     <span>Leads</span>
              ...
              <ul class="treeview-menu">
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
	         <li><a href="#"><i class="fa fa-circle-o"></i>All<small class="label pull-right bg-yellow">12</small></a>  
            
             
            </li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Very Hot<small class="label pull-right bg-yellow">1</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Hot<small class="label pull-right bg-yellow">2</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Moderate<small class="label pull-right bg-yellow">122</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Cold<small class="label pull-right bg-yellow">12</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Very Cold<small class="label pull-right bg-yellow">12</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Unclassified<small class="label pull-right bg-yellow">2</small></a></li>
                    
                  </ul>
                </li>
	   
	   <li class="treeview">
                  <a href="#"><i class=""></i>Todo List
                  ...
                  <ul class="treeview-menu">
	         <li><a href="#"><i class="fa fa-circle-o"></i>All Listings   <small class="label pull-right bg-yellow">12</small></a>  
            
             
            </li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>For Sale <small class="label pull-right bg-yellow">1</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>For Rent <small class="label pull-right bg-yellow">2</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Wanted <small class="label pull-right bg-yellow">122</small></a></li>
                    
                  </ul>
                </li>
	   
	   <li class="treeview">
                  <a href="#"><i class=""></i>Search Leads
            ...
            <li class="treeview">
                  ...
                  <ul class="treeview-menu">
	         <li><a href="#"><i class="fa fa-circle-o"></i>Closed (Won)<small class="label pull-right bg-yellow">12</small></a>  
            
             
            </li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Closed (Lost)<small class="label pull-right bg-yellow">1</small></a></li>
            ...
            <li class="treeview">
             ...
             <li class="treeview">
                  <a href="#"><i class=""></i>Deleted Leads
            ...
            <li class="treeview">
                  <a href="#"><i class=""></i>Token Recieved
            ...
            <li class="treeview">
                  <a href="#"><i class=""></i>Notifications
            ...
            <li class="treeview">
                  <a href="#"><i class=""></i>Shared Labels
	     ...
	     <span>Reports</span>
            ...
            <li class="treeview">
                  <a href="#"><i class=""></i>Activity Report</a>
            </li>
            
             <li class="treeview">
                  <a href="#"><i class=""></i>KPI Report</a>
            </li>
	     ...
	     <span>Clients</span>
            ...
            <li class="treeview">
                  <a href="#"><i class=""></i>Summary</a>
            </li>
            
             <li class="treeview">
                  <a href="#"><i class=""></i>Manage Clients
	         ...
	         <li><a href="#"><i class="fa fa-circle-o"></i>All<small class="label pull-right bg-yellow">12</small></a>  
                    ...
                    <li><a href="#"><i class="fa fa-circle-o"></i>Very Rich<small class="label pull-right bg-yellow">1</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Rich<small class="label pull-right bg-yellow">2</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Middle Class<small class="label pull-right bg-yellow">122</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Lower Middle<small class="label pull-right bg-yellow">12</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Poor<small class="label pull-right bg-yellow">12</small></a></li>
                  
                    
                  </ul>
                </li>
            <li class="treeview">
                  <a href="#"><i class=""></i>Search Clients</a>
            </li>
            <li class="treeview">
                  <a href="#"><i class=""></i>Add New Client</a>
            </li>
            <li class="treeview">
                  <a href="#"><i class=""></i>Deleted Client</a>
            </li>
	     ...
	     <span>Call Center</span>
            ...
            <li class="treeview">
	         ...
	         <li><a href="#"><i class="fa fa-circle-o"></i>All<small class="label pull-right bg-yellow">12</small></a>  
                    ...
                    <li><a href="#"><i class="fa fa-circle-o"></i>Hot<small class="label pull-right bg-yellow">1</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Very Hot<small class="label pull-right bg-yellow">2</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Moderate<small class="label pull-right bg-yellow">122</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Cold<small class="label pull-right bg-yellow">12</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Very Cold<small class="label pull-right bg-yellow">12</small></a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>Unclassified<small class="label pull-right bg-yellow">12</small></a></li>
       ...
       <li>
          <a href="">
            <i class="fa fa-globe"></i> <span>Agency Website</span>
